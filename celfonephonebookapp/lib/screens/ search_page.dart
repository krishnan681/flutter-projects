...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget GoldTierCard({
    ...
    required VoidCallback onEnquiryTap,
  ...
  Widget _tieredBusinessCard(
    ...
    if (tier == 'gold') {
        ...
        onFavoriteTap: () {
          _checkLoginAndProceed(() {
            showModalBottomSheet(
              ...
              builder: (context) {
                return FavoriteOptionsModal(name: name, mobile: mobile);
              },
            );
          });
        },
      ...
      Color stripeColor = const Color(0xFFB0BEC5);
      Color borderColor = const Color(0xFF90A4AE);
      IconData? tierIcon = Icons.star;
      Color? tierIconColor = Colors.blueGrey[400];
      ...
      // Normal tier using BusinessCard
      String maskedMobile = mobile.length >= 5
          ? "${mobile.substring(0, 5)} XXXXX"
          : mobile;
      ...
      return BusinessCard(
        name: name,
        city: "$city, $pincode", // Combine city and pincode for consistency
        mobile: maskedMobile,
        tier: tier,
        onFavoriteTap: () {
          _checkLoginAndProceed(() {
...
class BusinessCard extends StatelessWidget {
  ...
  final VoidCallback onEnquiryTap;
  ...
  @override
  Widget build(BuildContext context) {
    final bool isPlatinum = tier.toLowerCase() == "platinum";

    // Tier-based colors
    final Color borderColor = isPlatinum
        ? const Color(0xFFE91E63)
        : Colors.grey.shade400;
    final Color heartColor = isPlatinum
        ? const Color(0xFFE91E63)
        : Colors.grey.shade600;

    // Button colors based on tier
    final Color callBtnColor = isPlatinum
        ? Colors.green[600]!
        : Colors.grey.shade600;
    final Color enquireBtnColor = isPlatinum
        ? const Color(0xFFE91E63)
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(color: borderColor, width: isPlatinum ? 3 : 1.5),
          borderRadius: BorderRadius.circular(14),
          boxShadow: const [
            BoxShadow(
              color: Colors.black12,
        ...
        child: Stack(
          ...
          children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: onFavoriteTap,
                      child: Icon(Icons.favorite, color: heartColor, size: 28),
                    ),
                  ],
                ),
            ...
            // 🔹 Positioned Buttons (Call + Enquire)
            Positioned(
              top: 45,
              right: 0,
              child: Row(
